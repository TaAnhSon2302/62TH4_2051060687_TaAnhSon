...
/// Credits thanks to: https://github.com/dotnet/aspnetcore/blob/main/src/Identity/Core/src/IdentityApiEndpointRouteBuilderExtensions.cs
/// </summary>
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    ([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        ...
        //async Task CreateNewLoadOut(string email)
        //{
        //    UserManager<GameUser> users;
        ...
        async Task CreateNewLoadOut(string email, IServiceProvider serviceProvider)
        {
            ...
            {
                var dbContext = scope.ServiceProvider.GetRequiredService<TwoDCellsDbContext>();
        ...
        async Task CreateNewGun(string email, IServiceProvider service)
        {
